...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.estimated_time_input = Input(
            page, 'create-course-form-estimated-time-input', 'Estimated'
        )
        self.description_textarea = Textarea(
            page, 'create-course-form-description-input', 'Description'
        )
        self.max_score_input = Input(
            page, 'create-course-form-max-score-input', 'Max_score'
        )
        self.min_score_input = Input(
            page, 'create-course-form-min-score-input', 'Min_score'
        )

    @allure.step("Заполнить форму создания курса")
    ...
    @allure.step("Проверить видимость формы создания курса")
    def check_visible(
            self,
            title: str,
            estimated_time: str,
